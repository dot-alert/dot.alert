...
The Polkadot ecosystem also implements sophisticated on-chain governance mechanisms to defer the decision-making to token holders. The initial version of governance operations on Polkadot network involved two special bodies (a Council and a Technical committee) as representatives of passive token holders. The upcoming OpenGov update will eliminate these privileged roles and introduce on-chain collectives from which token holders can take a more active role in directing the network.&#x20;

<figure><img src="../../../.gitbook/assets/R_NOpenGov.JPG" alt="An overview of the OpenGov model for decentralised on-chain governance on Polkadot to encourage more participation from token holders."><figcaption><p><a href="https://polkadot.network/features/opengov/">Polkadot OpenGov</a> pushes for more active participation from token holders.</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/R_NKilt.JPG" alt="An overview of KILT&#x27;s Web3 services providing infrastructure for the creation of digital identities."><figcaption><p>Overview of KILT's Web3 services for self-sovereign decentralised identifiers.</p></figcaption></figure>
