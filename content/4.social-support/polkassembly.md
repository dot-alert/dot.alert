...
Because Polkassembly is an open platform and entirely automated. In this context, it is not always possible to eliminate spam and/or offensive comments in real-time, despite more active moderation strategies being implemented. Users are invited to report any post that they judge irrelevant or unsuitable for the topics in discussion, which will be handled by the moderation team.
