...
Portfolio management encompasses a range of [operations](../) that allow users to monitor, preserve, and grow their assets. Because assets valuations can vary greatly over a short period of time, sourcing suitable portfolio management tools is key to maintaining or increasing acquired value while dealing with uncertainties.
...
As there is a [growing number of assets](../../5.regulations/investments/issuance.md) (i.e stablecoins, network tokens, NFTs, staking and crowdloan derivatives, etc.) that are traded over different dapps, users need customisable interfaces to build an in-depth view of their holdings. DeFi platforms and Data Aggregators are partnering to give advanced network participants the opportunity to build their own native swapping solutions. Some of these include watching token pairs activities, retrieving price feeds, or running arbitrage bots.
